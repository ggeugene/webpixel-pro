...
function clean_custom_menus() {
	...
	if (($locations = get_nav_menu_locations()) && isset($locations[$menu_name])) {
        ...
        $menu_list .= '<div class="preloader-container"><div class="preloader-square"></div><div class="preloader-square"></div><div class="preloader-square"></div><div class="preloader-square"></div><div class="preloader-square"></div></div>';
        ...
        <img src="/wp-content/themes/webpixel/img/logo_mini.png"/>
...
function webpixel_project_slider_shortcode( $atts ) {
    ...
    if($query->have_posts()) { 
        ...
        foreach($query->posts as $post) {
            ...
            if(!empty($post_thumb)) {
                $string .= '<img class="carousel-item-image" src="' . $post_thumb . '"/>';
            } else {
